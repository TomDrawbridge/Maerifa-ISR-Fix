...
import Globe from "../../Globe"; // plasmic-import: 0p5SDzevCBLn/codeComponent
...
import sty from "./PlasmicBentoBox.module.css"; // plasmic-import: DAE3NiFvGT61/css

import Icon10Icon from "./icons/PlasmicIcon__Icon10"; // plasmic-import: -vkgHVWNbbvW/icon

createPlasmicElementProxy;

export type PlasmicBentoBox__VariantMembers = {
  type: "globe" | "noImage" | "midWidth" | "vertical" | "noHoverButton";
  color: "white";
  noImageTypes: "smallText" | "slot";
};
export type PlasmicBentoBox__VariantsArgs = {
...
type VariantPropType = keyof PlasmicBentoBox__VariantsArgs;
export const PlasmicBentoBox__VariantProps = new Array<VariantPropType>(
  "type",
  "color",
  "noImageTypes"
);

export type PlasmicBentoBox__ArgsType = {
...
type ArgPropType = keyof PlasmicBentoBox__ArgsType;
export const PlasmicBentoBox__ArgProps = new Array<ArgPropType>(
  "slot",
  "header",
  "svgUrl",
  "children",
...
export type PlasmicBentoBox__OverridesType = {
  bentoBox?: Flex__<"div">;
  ...
  image?: Flex__<"span">;
  freeBox?: Flex__<"div">;
  globe?: Flex__<typeof Globe>;
};

export interface DefaultBentoBoxProps {
  slot?: React.ReactNode;
  header?: string;
  svgUrl?: string;
  children?: React.ReactNode;
...
function PlasmicBentoBox__RenderFunc(props: {
  variants: PlasmicBentoBox__VariantsArgs;
  args: PlasmicBentoBox__ArgsType;
  overrides: PlasmicBentoBox__OverridesType;
  forNode?: string;
}) {
    ...
    >
      <span
        className={classNames(
          ...
          sty.span__lx6K5,
          {
            [sty.spancolor_white__lx6K5EHuy2]: hasVariant(
              $state,
              "color",
              "white"
            ),
            [sty.spannoImageTypes_slot__lx6K5TwP7V]: hasVariant(
              $state,
              "noImageTypes",
              "slot"
            ),
            [sty.spannoImageTypes_smallText__lx6K5LDifG]: hasVariant(
              $state,
              "noImageTypes",
              "smallText"
            ),
            [sty.spantype_noImage__lx6K5AG4G8]: hasVariant(
              $state,
              "type",
              "noImage"
            ),
            [sty.spantype_vertical__lx6K5JtnFp]: hasVariant(
              $state,
              "type",
              "vertical"
            )
      ...
      <span
        className={classNames(
          ...
          sty.span__j6UuG,
          {
            [sty.spancolor_white__j6UuGeHuy2]: hasVariant(
              $state,
              "color",
              "white"
            ),
            [sty.spannoImageTypes_slot__j6UuGtwP7V]: hasVariant(
              $state,
              "noImageTypes",
              "slot"
            ),
            [sty.spannoImageTypes_smallText__j6UuGlDifG]: hasVariant(
              $state,
              "noImageTypes",
              "smallText"
            ),
            [sty.spantype_globe__j6UuGh0HLz]: hasVariant(
              $state,
              "type",
              "globe"
            ),
            [sty.spantype_midWidth__j6UuGpdtfi]: hasVariant(
              $state,
              "type",
              "midWidth"
            ),
            [sty.spantype_noHoverButton__j6UuGcK0Qt]: hasVariant(
              $state,
              "type",
              "noHoverButton"
            ),
            [sty.spantype_noImage__j6UuGaG4G8]: hasVariant(
              $state,
              "type",
              "noImage"
            ),
            [sty.spantype_vertical__j6UuGjtnFp]: hasVariant(
              $state,
              "type",
              "vertical"
            )
      ...
      >
        {false
          ? renderPlasmicSlot({
              defaultContents: (
                <Icon10Icon
                  className={classNames(projectcss.all, sty.svg__jub3R, {
                    [sty.svgnoImageTypes_slot__jub3RtwP7V]: hasVariant(
                      $state,
                      "noImageTypes",
                      "slot"
                    )
              ...
              className: classNames(sty.slotTargetChildren, {
                ...
                [sty.slotTargetChildrennoImageTypes_slot]: hasVariant(
                  $state,
                  "noImageTypes",
                  "slot"
                )
        ...
        <Stack__
          ...
          className={classNames(projectcss.all, sty.textContent, {
            [sty.textContentcolor_white]: hasVariant($state, "color", "white"),
        ...
        >
          <h4
            ...
            className={classNames(
              ...
              sty.h4,
              {
                [sty.h4color_white]: hasVariant($state, "color", "white"),
                [sty.h4noImageTypes_slot]: hasVariant(
                  $state,
                  "noImageTypes",
                  "slot"
                ),
                [sty.h4noImageTypes_smallText]: hasVariant(
                  $state,
                  "noImageTypes",
                  "smallText"
                )
          ...
          <ReadMoreButton
            ...
            className={classNames("__wab_instance", sty.readMoreButton, {
              [sty.readMoreButtoncolor_white]: hasVariant(
                $state,
                "color",
                "white"
              ),
            ...
            white={hasVariant($state, "color", "white") ? true : undefined}
          />
        </Stack__>
      </span>
      <span
        ...
        className={classNames(projectcss.all, projectcss.span, sty.image, {
          [sty.imagecolor_white]: hasVariant($state, "color", "white"),
          [sty.imagecolor_white_type_vertical]:
            hasVariant($state, "color", "white") &&
            hasVariant($state, "type", "vertical"),
          [sty.imagenoImageTypes_slot]: hasVariant(
            $state,
            "noImageTypes",
            "slot"
          ),
          [sty.imagenoImageTypes_smallText]: hasVariant(
            $state,
            "noImageTypes",
            "smallText"
          ),
          [sty.imagetype_globe]: hasVariant($state, "type", "globe"),
          [sty.imagetype_midWidth]: hasVariant($state, "type", "midWidth"),
          [sty.imagetype_midWidth_color_white]:
            hasVariant($state, "type", "midWidth") &&
            hasVariant($state, "color", "white"),
          [sty.imagetype_noHoverButton]: hasVariant(
            $state,
            "type",
            "noHoverButton"
          ),
          [sty.imagetype_noImage]: hasVariant($state, "type", "noImage"),
          [sty.imagetype_vertical]: hasVariant($state, "type", "vertical")
        })}
      >
        <div
          ...
          className={classNames(projectcss.all, sty.freeBox, {
            ...
            [sty.freeBoxtype_globe]: hasVariant($state, "type", "globe"),
            [sty.freeBoxtype_midWidth]: hasVariant($state, "type", "midWidth"),
            [sty.freeBoxtype_vertical]: hasVariant($state, "type", "vertical")
          })}
        >
          {(hasVariant($state, "type", "globe") ? false : true)
            ? renderPlasmicSlot({
                defaultContents: (
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__fvEuk)}
                    displayHeight={"auto"}
        ...
        {(hasVariant($state, "type", "globe") ? true : false) ? (
          <Globe
            data-plasmic-name={"globe"}
            data-plasmic-override={overrides.globe}
            baseColor={"2.5,3.5,5"}
            className={classNames("__wab_instance", sty.globe, {
              [sty.globetype_globe]: hasVariant($state, "type", "globe")
            })}
            dark={1}
...
const PlasmicDescendants = {
  ...
  textContent: ["textContent", "h4", "text", "readMoreButton"],
  h4: ["h4"],
  text: ["text"],
  readMoreButton: ["readMoreButton"],
  image: ["image", "freeBox", "globe"],
  freeBox: ["freeBox"],
  globe: ["globe"]
} as const;
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicBentoBox__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicBentoBox__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicBentoBox__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicBentoBox__ArgProps,
          internalVariantPropNames: PlasmicBentoBox__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicBentoBox__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "bentoBox") {
    func.displayName = "PlasmicBentoBox";
  } else {
    func.displayName = `PlasmicBentoBox.${nodeName}`;
  }
  return func;
}

export const PlasmicBentoBox = Object.assign(
  // Top-level PlasmicBentoBox renders the root element
  makeNodeComponent("bentoBox"),
  {
    ...
    globe: makeNodeComponent("globe"),

    // Metadata about props expected for PlasmicBentoBox
    internalVariantProps: PlasmicBentoBox__VariantProps,
    internalArgProps: PlasmicBentoBox__ArgProps
  }
);

export default PlasmicBentoBox;
/* prettier-ignore-end */
