...
import sty from "./PlasmicIcon.module.css"; // plasmic-import: LC8-k9HAj7G6/css
...
export type PlasmicIcon__VariantsArgs = {
  colour?: SingleChoiceArg<"blue">;
};
type VariantPropType = keyof PlasmicIcon__VariantsArgs;
export const PlasmicIcon__VariantProps = new Array<VariantPropType>("colour");

export type PlasmicIcon__ArgsType = {
  svgUrl?: string;
};
type ArgPropType = keyof PlasmicIcon__ArgsType;
export const PlasmicIcon__ArgProps = new Array<ArgPropType>("svgUrl");
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        sty.root,
        { [sty.rootcolour_blue]: hasVariant($state, "colour", "blue") }
      )}
    >
      <svg
        ...
        className={classNames(projectcss.all, sty.icon2, {
          [sty.icon2colour_blue]: hasVariant($state, "colour", "blue")
        })}
        role={"img"}
      />
    </div>
