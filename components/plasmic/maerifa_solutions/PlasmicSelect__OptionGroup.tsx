...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: U-c5uqCklJTj/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: Xa-NSX71gNXM/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__g6I1A)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__qt8Ce)}
              />
            </React.Fragment>
          ),
          value: args.children
