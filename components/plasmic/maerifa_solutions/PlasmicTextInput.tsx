...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: gSAGOIgLlV1m/css

import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: uLZxFNTmn-hy/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__v9RbD)}
              role={"img"}
            />
          ),
      ...
      <input
        ...
        className={classNames(projectcss.all, projectcss.input, sty.input, {
          ...
          [sty.inputcolor_unnamedVariant]: hasVariant(
            $state,
            "color",
            "unnamedVariant"
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___7Rtug)}
              role={"img"}
            />
          ),
