...
export type IntelLogo2020LightBlueSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function IntelLogo2020LightBlueSvgIcon(
  props: IntelLogo2020LightBlueSvgIconProps
) {
...
export default IntelLogo2020LightBlueSvgIcon;
/* prettier-ignore-end */
