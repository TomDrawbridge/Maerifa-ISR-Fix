...
export type NvidiaLogo1SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function NvidiaLogo1SvgIcon(props: NvidiaLogo1SvgIconProps) {
...
export default NvidiaLogo1SvgIcon;
/* prettier-ignore-end */
