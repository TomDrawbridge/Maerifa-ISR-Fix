...
export type SuperMicroComputerLogo1SvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function SuperMicroComputerLogo1SvgIcon(
  props: SuperMicroComputerLogo1SvgIconProps
) {
  ...
  return (
    ...
    >
      ...
      <ellipse
        transform={"matrix(.9961 -.08771 .08771 .9961 -4.472 10.65)"}
        cx={"118.9"}
        cy={"56.2"}
        rx={"100.8"}
        ry={"50.5"}
      ...
      <path
        d={
          "M220.2 45.9c3.9 31.4-42.3 62.9-103.2 70.4S4.1 104.4.2 73s42-62.9 102.9-70.4 113.3 11.9 117.1 43.3zm-105.7-40C59 10.8 16 37.3 18.5 65.1s49.4 46.4 104.9 41.5 98.5-31.4 96-59.2C216.9 19.5 170 1 114.5 5.9z"
        }
        fill={"#00953b"}
      ></path>

      <circle cx={"218.9"} cy={"61.6"} r={"11.6"} fill={"#d7282f"}></circle>

      <path
        d={
          "M215.5 19.9c.5 0 .9.1 1.4.4.4.2.8.6 1 1 .3.5.4.9.4 1.4 0 .5-.1 1-.4 1.4-.2.4-.6.8-1 1-.4.2-.9.4-1.4.4-.5 0-1-.1-1.4-.4-.4-.2-.8-.6-1-1-.2-.4-.4-.9-.4-1.4 0-.5.1-1 .4-1.4.3-.4.6-.8 1.1-1 .4-.3.9-.4 1.3-.4zm0 .2c-.4 0-.8.1-1.3.3s-.7.5-1 .9c-.2.4-.3.8-.3 1.3 0 .4.1.9.3 1.3.2.4.5.7.9.9.4.2.8.3 1.3.3.4 0 .9-.1 1.3-.3.4-.2.7-.5.9-.9.2-.4.3-.8.3-1.3 0-.4-.1-.9-.3-1.3-.2-.4-.5-.7-1-.9s-.6-.3-1.1-.3zm-1.5.8h1.5c.4 0 .7.1.9.3s.3.4.3.6c0 .2-.1.4-.2.5-.1.2-.4.3-.7.3l.8 1.2.3.3c.1 0 .1.1.2.1v.1h-.7l-1.2-1.6h-.3V24c0 .1.1.2.1.2.1 0 .2.1.4.1v.1h-1.5v-.1h.3c.1 0 .1-.1.1-.1v-2.8c0-.1-.1-.1-.1-.1h-.3v-.4zm.9 1.7c.3 0 .5 0 .7-.1.1-.1.3-.1.3-.3.1-.1.1-.2.1-.4s-.1-.4-.2-.5c-.1-.1-.3-.2-.6-.2-.1 0-.2 0-.3.1v1.4z"
        }
        fill={"#003a70"}
      ></path>
...
export default SuperMicroComputerLogo1SvgIcon;
/* prettier-ignore-end */
